...
function($, ko, config, service, _) {
    ...
    */
    ...
    function getBandListHex(selectBand) {
        ...
        else if (selectBand == 8) {
            return "8,0,0,0,0,0,0,0";
        }
        else if (selectBand == 7) {
            return "16,0,0,0,0,0,0,0";
        }
        else if (selectBand == 6) {
            return "0,8,0,0,0,0,0,0";
        }
        else if (selectBand == 5) {
            return "0,16,0,0,0,0,0,0";
        }
        else if (selectBand == 4) {
            return "0,0,1,0,0,0,0,0";
        }
        else if (selectBand == 3) {
            return "10,0,0,0,0,0,0,0";
        }
        else if (selectBand == 2) {
            return "0,8,1,0,0,0,0,0";
        }
        else {
            return "26,24,1,0,0,0,0,0";
        }
    ...
    */
    ...
    function getBandIndex(bandlist) {
        ...
        else if (bandlist[16] == "1" && bandlist[11] == "1" && bandlist[1] == "0" && bandlist[3] == "0" && bandlist[12] == "0") {
            return 2;
        }
        else if (bandlist[1] == "1" && bandlist[3] == "1" && bandlist[11] == "0" && bandlist[16] == "0" && bandlist[12] == "0") {
            return 3;
        }
        else if (bandlist[16] == "1" && bandlist[3] == "0" && bandlist[11] == "0" && bandlist[1] == "0" && bandlist[12] == "0") {
            return 4;
        }
        else if (bandlist[16] == "0" && bandlist[3] == "0" && bandlist[11] == "0" && bandlist[1] == "0" && bandlist[12] == "1") {
            return 5;
        }
        else if (bandlist[4] == "1" && bandlist[1] == "0" && bandlist[3] == "0" && bandlist[16] == "0" && bandlist[12] == "0") {
            return 7;
        }
        else if (bandlist[11] == "1" && bandlist[1] == "0" && bandlist[3] == "0" && bandlist[16] == "0" && bandlist[12] == "0") {
            return 6;
        }
        else if (bandlist[3] == "1" && bandlist[11] == "0" && bandlist[1] == "0" && bandlist[16] == "0" && bandlist[12] == "0") {
            return 8;
        }
        else if (bandlist[1] == "1" && bandlist[3] == "0" && bandlist[11] == "0" && bandlist[16] == "0" && bandlist[12] == "0") {
            return 9;
        }
        else {
            return 1;
