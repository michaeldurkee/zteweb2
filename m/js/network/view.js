...
//                    successOverlay();
    ...
    function refreshStatus() {
        ...
        var $conimg = $('img', '#connection_img');
        if (status == 1) {			
            $conimg.attr('src') != './img/connected.png' && $conimg.attr('src', './img/connected.png');
            ...
            $conimg.attr('src') != './img/disconnecting.png' && $conimg.attr('src', './img/disconnecting.gif');
            networkViewUtil.setData('connection_status', $.i18n.prop('disconnecting'));
            networkViewUtil.setData('connection_desc', '');
        } else if (status == 3) {
            $conimg.attr('src') != './img/connecting.png' && $conimg.attr('src', './img/connecting.gif');
            networkViewUtil.setData('connection_status', $.i18n.prop('connecting'));
            networkViewUtil.setData('connection_desc', '');
        } else if (status == 4) {
            $conimg.attr('src') != './img/disconnected.png' && $conimg.attr('src', './img/disconnected.png');
