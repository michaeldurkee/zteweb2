define(['underscore', 'config/config', 'smsData'],function (_, config, smsData) {
    ...
    var simulate = {
                ...
                if (params.goformId == "PBM_CONTACT_ADD") {
                   ...
                   return validatePUK(params);
                    ...
                    /*if(this.m_AuthMode == "OPEN") {
                        params.m_EncrypType == "WEP" ? this.m_EncrypType = "WEP" : this.m_EncrypType = "NONE";
                    } else if (this.m_AuthMode == "WPA2PSK") {
                        this.m_EncrypType = "CCMP";
                    } else if(this.m_AuthMode == "SHARED"){
						this.m_EncrypType = "WEP";
					} else {
					...
					if(config.WIFI_SWITCH_SUPPORT && typeof params.wifiEnabled != "undefined") {
						this.wifi_cur_state = params.wifiEnabled;
					}
					...
					simulate.blc_wan_mode = "PPPOE";
					simulate.ethwan_mode = "DHCP";
                    setOpmsWanMode("PPPOE")
				}else if(params.goformId == "WAN_GATEWAYMODE_AUTO"){
					simulate.blc_wan_mode = "PPPOE";
					simulate.ethwan_mode = "AUTO";
					simulate.pppoe_username = params.pppoe_username;
					simulate.pppoe_password = params.pppoe_password;
                    setOpmsWanMode("PPPOE")
        ...
        sub_network_type:[ "GSM", "GPRS", "EDGE", "WCDMA", "HSDPA", "HSPA", "HSPA+", "DC-HSPA+", "LTE" ][getRandomInt(8)],
        rssi:"-" + 9 * getRandomInt(5),
        rscp:"-" + 9 * getRandomInt(5),
        lte_rsrp:"-" + 9 * getRandomInt(5),
        network_provider:[ "China Mobile", "china unicom","中国电信" ][getRandomInt(2)],
        ...
        // sms_unread_num,sms_received_flag,sts_received_flag,wifi_cur_state,station_num,battery_charging,battery_value,loginfo,simcard_roam,spn_display_flag,plmn_display_flag,spn_name_data,lan_ipaddr
        net_select:"Only_WCDMA",
        m_netselect_contents:'2,China Mobile,46002,2;1,China Mobile,46002,7;1,China Unicom,46001,0;1,China Unicom,46001,7',
		rotationFlag:'1',
        realtime_rx_thrpt : 0,
        total_tx_bytes : 0,
        total_rx_bytes : 0,
        ...
        /*
    	"APN_config,dial_mode,m_profile_name,wan_apn,wan_dial,dns_mode,
    	...
    	*/
        ...
        authMode: 'OPEN',
        wps_type: 'PBC',
        wifi_cur_state:"1", // 1?enabled?0?disabled
...
//		rssi : '7',
        ...
        ex_wifi_status:"",
        EX_wifi_profile:"",
		blc_wan_mode: "PPPOE",//['PPPOE',  'PPP',  'AUTO'][getRandomInt(3)],//BRIDGE, PPPOE, DHCP, STATIC, PPP
		ethwan_mode:"AUTO",//PPPOE, DHCP, STATIC,AUTO
		blc_wan_auto_mode:[ 'AUTO_PPPOE', 'AUTO_PPP'][getRandomInt(3)],//BRIDGE, PPPOE, DHCP, STATIC, PPP
		pppoe_username:"user",
		ethwan_mode:"static",
		rj45_state:"idle",
...
//		rssi: '555',
	...
	setInterval(function(){
        ...
        } else if (simulate.ppp_status == "ppp_connected") {
    ...
    function getOpmsWanMode() {
        var blc_wan_mode = CookieUtil.get('blc_wan_mode');
        if (blc_wan_mode == null) {
            blc_wan_mode = ['AUTO', 'PPPOE', 'PPP'][getRandomInt(3)];
            simulate.blc_wan_mode = blc_wan_mode;
            CookieUtil.set('blc_wan_mode', blc_wan_mode, 30);
        }
        return blc_wan_mode;
    }
 ...
 function setUpgradeSelectOption(params) {
    ...
    function setOpmsWanMode(blc_wan_mode) {
        simulate.blc_wan_mode = blc_wan_mode;
        CookieUtil.set('blc_wan_mode', blc_wan_mode, 30);
    ...
    function editHostName(params) {
        simulate.childGroupList.devices = _.map(simulate.childGroupList.devices, function(ele){
