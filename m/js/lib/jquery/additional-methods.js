...
(function () {
    //set errorPlacement fro jquery mobile
...
jQuery.validator.addMethod("hostName_check", function (value, element, param) {
	var result = true;
	if(value.indexOf(" ") == 0 || value.lastIndexOf(" ") == (value.length - 1) || /[\*\$\[&:,;<>'"\\`\]￥]{1,32}/.test(value)){
		result = false;
	}
	return this.optional(element) || result;
});
