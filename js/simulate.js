define(['underscore', 'config/config', 'smsData'],function (_, config, smsData) {
    ...
    var simulate = {
                ...
                if (params.goformId == "PBM_CONTACT_ADD") {
                   ...
                   return validatePUK(params);
					...
					if(simulate.sntp_time_set_mode == "auto"){
						setTimeout(function(){
							if(sntpAutoFlag) {
								simulate.sntp_process_result = "success";
								sntpAutoFlag = false;
							} else {
								simulate.sntp_process_result = "failure";
								sntpAutoFlag = true;
							}
						}, 2000);
					}
        ...
        spn_b1_flag: '1',
        spn_b2_flag: '1',
        ppp_status:"ppp_connected", // 联网
        simcard_roam:"International", //漫游
        ...
        lte_band: "12",
        work_lte_band: "B,0,0,0,0,0,0,0",
        //work_lte_band: "133,0,0,0,224,1,0,0",
        cell_id: "1234",
        ...
        monthly_tx_bytes : 0,
        monthly_rx_bytes : 0,
        sntp_daily_reset_hour:5,
        sntp_daily_reset_min:45,
        sntp_reset_day:2,
        flux_last_month_total:'1544544444',
    ...
    var fileList = {
		"result" : {
			...
			"fileInfo" : [ {
				...
				"fileName" : "发多少公分的哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈�?jpg",
				"attribute" : "file",
				"size" : "456879",
				"lastUpdateTime" : "20120510"
			}, {
